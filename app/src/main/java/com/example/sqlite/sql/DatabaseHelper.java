...
//increment the database version.
    ...
    private static final String SQL_CREATE_TbMAHASISWA = String.format("CREATE TABLE %s (" +
                    "%s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT,%s TEXT,%s INTEGER,%s INTEGER,FOREIGN KEY( %s)" +
                    " REFERENCES %s(%s) ON UPDATE CASCADE ON DELETE CASCADE,FOREIGN KEY( %s) REFERENCES %s" +
                    "(%s) ON UPDATE CASCADE ON DELETE CASCADE)",
    ...
    private static final String SQL_CREATE_TbJURUSAN = String.format("CREATE TABLE %s (" +
