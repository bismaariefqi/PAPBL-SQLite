package com.example.sqlite.sql;
...
public class CrudHelper {
    ...
    public long insertJurusan(ContentValues values) {
        ...
        long _id = db.insert(DatabaseContract.TbJurusan.TABLE_NAME,
                null, values);
        return _id;
    }
...
//nilai null maka isi parameter tsb dgn nilai null
    ...
    public long insertMahasiswa(ContentValues values) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        long _id =
                db.insert(DatabaseContract.TbMahasiswa.TABLE_NAME,
                        null, values);
        return _id;
    }
    ...
    public ArrayList<HashMap<String, String>> getMahasiswa(@Nullable String _id) {
        ...
        String[] projection = {
                ...
                DatabaseContract.TbMahasiswa.TABLE_NAME + "." + DatabaseContract.TbMahasiswa.COLUMN_NAME_EMAIL + " as EmailMhs",
                DatabaseContract.TbDosen.TABLE_NAME + "." + DatabaseContract.TbDosen.COLUMN_NAME_NAMA + " as NamaDosen",
                DatabaseContract.TbJurusan.TABLE_NAME + "." + DatabaseContract.TbJurusan.COLUMN_NAME_NAMA + " as NamaJurusan"
        };
...
//menggunakan contoh join
        ...
        ArrayList<HashMap<String, String>> Mahasiswas = new
                ArrayList<HashMap<String, String>>();
        while (cursor.moveToNext()) {
            String id = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbMahasiswa.TABLE_NAME + "."
                            + DatabaseContract.TbMahasiswa._ID));
            String nama = cursor.getString(
                    cursor.getColumnIndexOrThrow("NamaMhs"));
            String email = cursor.getString(
                    cursor.getColumnIndexOrThrow("EmailMhs"));
            String dosenPa = cursor.getString(
                    cursor.getColumnIndexOrThrow("NamaDosen"));
            String jurusan = cursor.getString(
                    cursor.getColumnIndexOrThrow("NamaJurusan"));
    ...
    public ArrayList<HashMap<String, String>> getDosen(@Nullable String _id) {
        ...
        String sortOrder =
                DatabaseContract.TbDosen.COLUMN_NAME_NAMA + " DESC";
        ...
        ArrayList<HashMap<String, String>> Dosens = new
                ArrayList<HashMap<String, String>>();
        while (cursor.moveToNext()) {
            String id = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbDosen._ID));
            String nama = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbDosen.COLUMN_NAME_NAMA));
            String email = cursor.getString(
                    cursor.getColumnIndexOrThrow(DatabaseContract.TbDosen.COLUMN_NAME_EMAIL));
            HashMap<String, String> dosen = new
    ...
    public ArrayList<HashMap<String, String>> getJurusan(@Nullable String _id) {
        ...
        String sortOrder =
                DatabaseContract.TbJurusan.COLUMN_NAME_NAMA + " DESC";
        Cursor cursor = db.query(DatabaseContract.TbJurusan.TABLE_NAME + "", // The table to query
                projection, // The array of columns to return (pass null to get all)
                selection, // The columns for the WHERE clause
                selectionArgs, // The values for the WHERE clause
                null, // don't group the rows
...
// Issue SQL statement.
        int updateRows =
                db.update(DatabaseContract.TbMahasiswa.TABLE_NAME, cv
...
// Issue SQL statement.
        int updateRows =
                db.update(DatabaseContract.TbDosen.TABLE_NAME, cv
                        , selection, selectionArgs);
        return updateRows;
    }
...
// Issue SQL statement.
        int deletedRows =
                db.delete(DatabaseContract.TbMahasiswa.TABLE_NAME,
                        selection, selectionArgs);
        return deletedRows;
    }
...
// Issue SQL statement.
        int deletedRows =
                db.delete(DatabaseContract.TbDosen.TABLE_NAME,
                        selection, selectionArgs);
        return deletedRows;
    }
...
// Issue SQL statement.
        int deletedRows =
                db.delete(DatabaseContract.TbJurusan.TABLE_NAME,
                        selection, selectionArgs);
        return deletedRows;
    }
